#> ioi-pi:impl/modify_inventory/setup/boots
#
#   > Prepare the item from the player's feet armor slot into the shulker box
#
#@internal
...
#   Append the item from the player's feet armor slot into the `armor` NBT path
data modify storage ioi-pi:temp armor append from entity @s Inventory[{Slot: 100b}]
