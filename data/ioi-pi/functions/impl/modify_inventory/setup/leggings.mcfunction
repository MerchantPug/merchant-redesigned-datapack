#> ioi-pi:impl/modify_inventory/setup/leggings
#
#   > Prepare the item from the player's legs armor slot into the shulker box
#
#@internal
...
#   Append the item from the player's legs armor slot into the `armor` NBT path
data modify storage ioi-pi:temp armor append from entity @s Inventory[{Slot: 101b}]
