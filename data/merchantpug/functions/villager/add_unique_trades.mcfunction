...
execute if score @s merchantIsLibrarian matches 1 if score @s merchantRandomisedTradeId matches 5 run data modify entity @s Offers.Recipes append value {rewardExp:1b,maxUses:3,buy:{id:"minecraft:emerald",Count:1b},sell:{id:"minecraft:written_book",Count:1b,tag:{pages:['{"text":"Dear John,\\n\\nIt\'s been five and a half fortnights since your departure, and still, I yearn for you. I do hope your studies abroad with the clergy go well, and that the knowledge that comes from it aids you greatly."}','{"text":"Although I do not quite understand the importance of these runes, I at least respect your investment in the little function they serve. You must respect my position too, as it is quite hard to believe that some curious rock has the ability to alter your visuals."}','{"text":"Hearing your stories about the colors and dust that appear when you utilize your tools with the strange disks does worry me, John. That\'s why I send you this letter, I am worried about you and your future. I think it is best for us to go our separate ways, "}','{"text":"as I worry I encourage your outlandish dreams unintentionally. Just know you will always be in my heart, and that there will be no man quite like you in my life.\\n\\nLove, Liz"}'],title:"Dear John.",author:Liz,generation:2}}}
execute if score @s merchantIsLibrarian matches 1 if score @s merchantRandomisedTradeId matches 5 run execute store result entity @s Offers.Recipes[{sell:{id:"minecraft:written_book",tag:{title:"Dear John.",author:"Liz"}}}].uses int 1 run scoreboard players get @s merchantTraderTradeUses

#   Mt. Fletching Excavation Notes
execute if score @s merchantIsLibrarian matches 1 if score @s merchantRandomisedTradeId matches 6 run data modify entity @s Offers.Recipes append value {rewardExp:1b,maxUses:3,buy:{id:"minecraft:emerald",Count:1b},sell:{id:"minecraft:written_book",Count:1b,tag:{pages:['["",{"text":"SITE #","bold":true},{"text":"  156        ","color":"reset","underlined":true},{"text":"\\n\\n","color":"reset"},{"text":"SITE NAME","bold":true},{"text":"\\n","color":"reset"},{"text":"Mt. Fletching","underlined":true},{"text":"\\n\\n","color":"reset"},{"text":"FINDS","bold":true},{"text":"\\n","color":"reset"},{"text":"ID |    DESCRIPTION  |\\n55 |       Flint     |","underlined":true},{"text":"\\n","color":"reset"},{"text":"56 |   More Flint   |","underlined":true},{"text":"\\n\\n","color":"reset"},{"text":"EXCAV. PROCEDURES","bold":true},{"text":"\\nIf you find gravel, place it directly on the gravel brush.","color":"reset"}]'],title:"Mt. Fletching Excavation Notes",author:"Village Excavationists",generation:3}}}
execute if score @s merchantIsLibrarian matches 1 if score @s merchantRandomisedTradeId matches 6 run execute store result entity @s Offers.Recipes[{sell:{id:"minecraft:written_book",tag:{title:"Mt. Fletching Excavation Notes",author:"Village Excavationists"}}}].uses int 1 run scoreboard players get @s merchantTraderTradeUses
