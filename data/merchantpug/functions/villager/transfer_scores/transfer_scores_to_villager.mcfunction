...
execute as @e[type=marker,tag=merchant.villager_paired] if score @s markerTime = #current_gametime markerTime run scoreboard players operation #current merchantTraderTradeUses = @s merchantTraderTradeUses
...
execute as @e[type=minecraft:villager] if score @s merchantVillagerId = #current merchantVillagerId run scoreboard players operation @s merchantTraderTradeUses = #current merchantTraderTradeUses
...
scoreboard players reset #current merchantTraderTradeUses