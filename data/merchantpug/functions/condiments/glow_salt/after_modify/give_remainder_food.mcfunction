...
data modify block -30000000 -64 1602 Items[{Slot:0b}].id set from storage merchantpug:previous_food item.id
data modify block -30000000 -64 1602 Items[{Slot:0b}].Count set from storage merchantpug:previous_food item.Count
data modify block -30000000 -64 1602 Items[{Slot:0b}].tag set from storage merchantpug:previous_food item.tag
