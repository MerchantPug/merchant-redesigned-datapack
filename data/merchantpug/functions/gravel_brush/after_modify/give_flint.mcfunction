...
execute if score #total_elements gravel matches 41.. run loot spawn ~ ~ ~ mine -30000000 -64 1602 minecraft:air{drop_contents: 1b}

execute unless score #total_elements gravel matches 41.. run loot give @s mine -30000000 -64 1602 minecraft:air{drop_contents: 1b}
