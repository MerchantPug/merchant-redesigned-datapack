...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"legs", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/frost/frost_rune_legs"}