...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"head", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/emerald/emerald_rune_head"}