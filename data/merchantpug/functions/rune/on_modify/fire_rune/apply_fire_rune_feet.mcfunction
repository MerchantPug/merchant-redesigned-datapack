...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"feet", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/fire/fire_rune_feet"}