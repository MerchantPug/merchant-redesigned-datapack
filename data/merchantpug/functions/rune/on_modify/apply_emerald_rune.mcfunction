...
#   Consume the knowledge book
clear @s minecraft:knowledge_book{ioi-pi: {selected: 1b, extra: 1b}} 1
...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"mainhand", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/emerald_rune_tool"}