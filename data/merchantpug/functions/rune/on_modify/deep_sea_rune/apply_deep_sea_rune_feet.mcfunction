...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"feet", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/deep_sea/deep_sea_rune_feet"}