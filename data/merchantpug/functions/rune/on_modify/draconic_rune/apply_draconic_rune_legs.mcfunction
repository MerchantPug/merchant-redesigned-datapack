...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"legs", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/draconic/draconic_rune_legs"}