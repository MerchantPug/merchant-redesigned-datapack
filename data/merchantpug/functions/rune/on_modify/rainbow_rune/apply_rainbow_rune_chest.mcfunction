...
data modify storage ioi-pi:output item.tag.Powers append value {Slot:"chest", Hidden:0b, Negative: 0b, Power: "merchantpug:global/runes/effect/rainbow/rainbow_rune_chest"}