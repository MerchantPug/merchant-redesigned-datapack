...
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:bread",tag:{CustomModelData:417651}}}] at @s if block ~ ~ ~ minecraft:water store result score #temp merchantBurleyCount run data get entity @s Item.Count
