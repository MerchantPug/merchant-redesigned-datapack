...
#   Decrement 
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:nether_brick",tag:{CustomModelData:417651}}}] at @s if block ~ ~ ~ minecraft:water store result entity @s Item.Count int 1 run scoreboard players get #temp merchantBurleyCount
