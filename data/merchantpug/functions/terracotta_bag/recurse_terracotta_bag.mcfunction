...
execute if score #total_elements giveTerracotta matches 37.. run loot spawn ~ ~ ~ mine -30000000 0 1602 minecraft:air{drop_contents: 1b}

execute unless score #total_elements giveTerracotta matches 37.. run loot give @s mine -30000000 0 1602 minecraft:air{drop_contents: 1b}
