...
execute if score #temp emeralds < emeraldPouchMax merchantConfig run scoreboard players remove #temp addedEmeralds 1

#   Add to emeralds score
execute if score #temp emeralds < emeraldPouchMax merchantConfig run scoreboard players add #temp emeralds 1

# Add score for if the pouch is full
scoreboard objectives add isFull dummy
execute unless score #temp emeralds < emeraldPouchMax merchantConfig run scoreboard players set #temp isFull 1
...
execute if score #temp addedEmeralds matches 1.. if score #temp emeralds < emeraldPouchMax merchantConfig run function merchantpug:emerald_pouch/add_to_emeralds